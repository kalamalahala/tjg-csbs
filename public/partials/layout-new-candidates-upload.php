            ...
            <div class="col">
                <form id="tjg-csbs-upload-new-candidates" method="post" enctype="multipart/form-data" action="">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control-file" id="tjg-csbs-upload-new-candidates-file" name="tjg-csbs-upload-new-candidates-file">
                        </div>
                    </div>
                    ...
                    <div class="form-group row tjg-csbs-summary">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="tjg-csbs-upload-new-candidates-summary" name="tjg-csbs-upload-new-candidates-summary" rows="3" readonly></textarea>
                        </div>
                    </div>
