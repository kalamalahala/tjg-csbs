(function ($) {
  ...
  $(document).ready(function () {
    ...
    const fileInput = document.getElementById(
      "tjg-csbs-upload-new-candidates-file"
    );
    const textarea = document.getElementById(
      "tjg-csbs-upload-new-candidates-summary"
    );
    const trashButton = document.getElementById(
      "tjg-csbs-upload-new-candidates-trash"
    );
    ...
    $(form).on("submit", form, function (e) {
      ...
      const firstNameColumn = document.getElementById(
        "tjg-csbs-upload-new-candidates-first-name"
      );
      const lastNameColumn = document.getElementById(
        "tjg-csbs-upload-new-candidates-last-name"
      );
      const emailColumn = document.getElementById(
        "tjg-csbs-upload-new-candidates-email"
      );
      const phoneColumn = document.getElementById(
        "tjg-csbs-upload-new-candidates-phone"
      );
      const cityColumn = document.getElementById(
        "tjg-csbs-upload-new-candidates-city"
      );
      const stateColumn = document.getElementById(
        "tjg-csbs-upload-new-candidates-state"
      );
      ...
      columnDefs: [
        {
          ...
          render: function (data, type, row, meta) {
            return (
              '<button class="btn btn-primary btn-sm tjg-csbs-candidate-interview" data-id="' +
              data +
              '" title="Start Interview"><i class="fa fa-phone"></i></button>' +
              '<button class="btn btn-info btn-sm tjg-csbs-candidate-update" data-id="' +
              data +
              '" style="margin-left: 8px;" title="View Info"><i class="fa fa-search"></i></button>' +
              '<button class="btn btn-danger btn-sm tjg-csbs-candidate-clear" data-id="' +
              data +
              '" style="margin-left: 8px;" title="Clear Candidate"><i class="fa fa-times"></i></button>'
            );
          },
        },
        {
	...
	$(".briefing_select").prop('hidden', true);
    ...
    $(document).on(
      "change",
      ".csbs_update_radio_email input",
      toggleGfFieldHiddenAttr
    );
  });
  ...
  function createSelectors(headerData) {
    ...
    const firstNameSelect = document.getElementById(
      "tjg-csbs-upload-new-candidates-first-name"
    );
    const lastNameSelect = document.getElementById(
      "tjg-csbs-upload-new-candidates-last-name"
    );
    const phoneSelect = document.getElementById(
      "tjg-csbs-upload-new-candidates-phone"
    );
    const emailSelect = document.getElementById(
      "tjg-csbs-upload-new-candidates-email"
    );
